...
Coords[] coords = Coords.mergeList(new Coords[][]{nami,aisha,videl,hinata,tatsuki});
        int slots=12;
        o.start();
        o.login(uni, nick, pass);
        slots = o.getSlotsTotal()-o.getSlotsOccupied();
        System.err.println("Will scan with "+slots+" fleets");
        o.changePlanet(3);
