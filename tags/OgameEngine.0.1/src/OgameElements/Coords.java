...
public class Coords implements Comparable {
    ...
    /**
     * Konwertuje kordynat do postaci xml
     * @return postac xml kordynatu
     */
    public String toXML() {
    ...
    static public Coords parserXML(Element root) throws NumberFormatException, OgameFileNotFoundException, OgameIOException {
        NodeList coord = root.getElementsByTagName(Coords.xmlHeader);
        Coords result = null;
        ...
        if (coord.getLength() > 0) {
            ...
            result = new Coords(str[0], str[1], str[2], dest);
        }
        return result;
    }
     ...
     */
    private static PropertiesCoords prop;
    ...
    public static final String xmlHeader = "coords";
}
