...
public class Mission {
    ...
    public static final Mission EXPLORE =new Mission("EXPLORE");//TODO musi jakoś przechować czas misji
    ...
    public static final Mission STAY=new Mission("STAY");//TODO musi jakoś przechować czas misji
